    ...
    items: [
      {
        ...
        items: [
          ...
          { text: 'Understanding Licensing', link: '/recruit/12-understanding-licensing/' },
          { text: 'Course Completion Badge', link: '/recruit/course-completion-badges-recruit/' },
        ],
      },
      {
        text: 'Operative',
        ...
        collapsed: true,
        items: [
          { text: 'Get started with the Hiring Agent', link: '/operative/01-get-started/' },
          { text: 'Authoring Agent Instructions', link: '/operative/02-agent-instructions/' },
          { text: 'Make your agent multi-agent ready', link: '/operative/03-multi-agent/' },
          { text: 'Automate your agent with Triggers', link: '/operative/04-automate-triggers/' },
          { text: 'Understanding Agent Models', link: '/operative/05-model-selection/' },
          { text: 'Content Moderation and AI Safety', link: '/operative/06-ai-safety/' },
          { text: 'Extracting Resume Contents', link: '/operative/07-multimodal-prompts/' },
          { text: 'Prompts - Dataverse Grounding', link: '/operative/08-dataverse-grounding/' },
          { text: 'Generating an Interview Prep Document', link: '/operative/09-document-generation/' },
          { text: 'Integrate with MCP Servers', link: '/operative/10-mcp/' },
          { text: 'Obtain User Feedback with Adaptive Cards', link: '/operative/11-obtain-user-feedback/' },
          { text: 'Course Completion Badge', link: '/operative/course-completion-badges-operative/' },
        ],
      },
      { text: 'Commander (Coming Soon)', link: '/commander/' },
    ],
