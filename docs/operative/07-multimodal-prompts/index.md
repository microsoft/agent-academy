...
[![Multimodal Prompts](./assets/07-multi-modal-prompts-thumbnail_PlayButton.png)](https://youtu.be/icP_qH8LFK8?si=VJjtdVi-ytUq0ymg "Watch the walkthrough on YouTube")
...
1. In the **Configure for use in Agent** dialog, select **Cancel**.
    ...
    > [!NOTE] Why we're not adding this as a tool yet
