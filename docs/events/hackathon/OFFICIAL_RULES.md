# MICROSOFT AGENTS ACADEMY HACKATHON CONTEST OFFICIAL RULES

![Agent Academy Live Banner](../hackathon/assets/AgentAcademyHackBanner.png)


## 1. SPONSOR

These Official Rules ("Rules") govern the operation of the Microsoft Agents Academy Live Challenge Contest ("Contest"). Microsoft Corporation, One Microsoft Way, Redmond, WA, 98052, USA, is the Contest sponsor ("Sponsor").
...
The Contest starts at 12:00 a.m. Pacific Time (PT) on May 12, 2026, and ends at 11:59 p.m. PT on June 2, 2026 ("Entry Period").
...
To register to participate in the Contest, you must register at the official Agent's Academy registration page at [https://aka.ms/agent-academy-live](https://aka.ms/agent-academy-live) ("Contest Website").

To create an entry, complete the following steps:

Follow the instructions on the Contest website and build an agent that meets the following criteria:

1. **Curriculum-aligned**: Must demonstrate one or more Agent Academy modules, patterns, or concepts that align with the Agent Academy curriculum for the applicable Track (as defined below).
1. **Problem-solving focused**: Each agent must address a real problem with a defined target user.
1. **Architected systems**: Submissions require an architecture overview with components, data flow, and integration points.
1. **Microsoft Ecosystems**: Each agent must be aligned with the Microsoft AI ecosystem, including use of at least one (1) of the following Microsoft products and services:
   - Microsoft Copilot Studio
   - Azure OpenAI Service
   - Microsoft Graph API
   - Power Automate

Make a demo video, featuring your agent. Your video must demonstrate your agent in action, and may be no longer than five (5) minutes in length.

To submit an entry, complete the following steps:

Pick one of the following tracks (each a "Track") to participate in at [https://aka.ms/agentacademy/submit](https://aka.ms/agentacademy/submit) ("Submission Website"):

- **Recruit** – For additional details about this Track, see [https://microsoft.github.io/agent-academy/recruit/](https://microsoft.github.io/agent-academy/recruit/)
- **Operative** – For additional details about this Track, see [https://microsoft.github.io/agent-academy/operative/](https://microsoft.github.io/agent-academy/operative/)
- **Special Ops** – For additional details about this Track, see [https://microsoft.github.io/agent-academy/special-ops/](https://microsoft.github.io/agent-academy/special-ops/)
- **Cowork Collective** – For additional details about this Track, see [https://microsoft.github.io/agent-academy/cowork-collective/](https://microsoft.github.io/agent-academy/cowork-collective/)

Submit your agent and demo video via GitHub issues in the Submission Website.

The entry limit is one (1) per Track and two (2) overall during the Entry Period. Any attempt by you to obtain more than the stated number of entries by using multiple/different accounts, email addresses, identities, registrations, logins, or any other methods will void your entries and you may be disqualified. Use of any automated system to participate is prohibited.
...
- The demo video portion of your entry must be solely your own work, including but not limited to, the actual filming, editing, graphic design, etc. of the video.
...
Pending confirmation of eligibility, potential prize winners will be selected by Microsoft, our designated agent, or a qualified judging panel from among all eligible entries received within each Track based on the following judging criteria:

- **25% - Accuracy & Relevance** — Meets challenge requirements
- **25% - Technical Execution** — Clear problem-solving approach
- **15% - Creativity & Originality** — Novel ideas or unexpected execution
- **15% - User Experience & Presentation** — Clear, polished, demoable
- **10% - Reliability & Safety** — Solid patterns, avoids obvious pitfalls
- **10% - Use Case Impact** — Most impactful use case

The judges will select three (3) potential winners from each Track, as provided in Section 9 (Prizes) below. Winners will be selected within fourteen (14) days following the Entry Period from among all eligible entries received.
...
Potential winners will be notified via the contact information provided during entry no more than seven (7) days following judging with prize claim instructions, including submission deadlines. If a selected winner cannot be contacted, is ineligible, fails to claim a prize or fails to return any forms, the selected winner will forfeit their prize and an alternate winner will be selected.

If you are a potential winner and you are eighteen (18) years of age or older but have not reached the age of majority in your legal place of residence, we may require your parent/legal guardian to sign all required forms on your behalf.

Only three (3) alternate winners will be selected, after which unclaimed prizes will remain unawarded.

## 9. PRIZES

The following prizes will be awarded in each Track:

**One (1) First Prize.** Each winner will receive:

- A Microsoft Store Gift Card. Approximate Retail Value (ARV) $1,500.00 USD.

**One (1) Second Prize.** Each winner will receive:

- A Microsoft Store Gift Card. Approximate Retail Value (ARV) $1,000.00 USD.

**One (1) Third Prize.** Each winner will receive:

- A Microsoft Store Gift Card. Approximate Retail Value (ARV) $500.00 USD.
...
In the event of a dispute, the decisions of Microsoft are final and binding.
...
Send an email to [poweradvocates@microsoft.com](mailto:poweradvocates@microsoft.com) with the subject line "Agents Academy Live Challenge Contest winners" within thirty (30) days of June 2, 2026 to receive a list of winners that received a prize worth $25.00 USD or more.
