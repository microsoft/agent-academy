...
| | Badge | Who earns it |
|---|---|---|
| ![Live Graduate badge](./assets/AcademyLiveGraduate.png){width=100} | **Live Graduate** | Every participant who completes the workshop |
| ![Live Instructor badge](./assets/AcademyInstructorBadge.png){width=100} | **Live Instructor** | Facilitators who deliver an official Agent Academy workshop |
