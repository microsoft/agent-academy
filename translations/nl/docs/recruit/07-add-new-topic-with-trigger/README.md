...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-17T06:02:23+00:00",
...
[![Trigger video thumbnail](../../../../../translated_images/video-thumbnail.a84cf7cb473be282861469420c5e2c16adb53bcfd64c7c07fbd579e8d32bf8b2.nl.jpg)](https://www.youtube.com/watch?v=7iPAZaA8nJs "Bekijk de uitleg op YouTube")

## 🎯 Missieoverzicht

Je hebt een agent gebouwd. Hij luistert, leert en beantwoordt vragen - maar nu is het tijd om tactischer te worden. In deze missie duik je diep in de kern en leer je je agent hoe hij met precisie op specifieke prompts kan reageren.

Met onderwerpen en triggers kan je agent:

- Intentie herkennen

- Gesprekken logisch sturen
...
1. De anatomie van onderwerpen begrijpen, inclusief triggerzinnen en gespreksknooppunten
1. Verschillende soorten gespreksknooppunten verkennen en Power Fx gebruiken voor dynamische logica
1. Zelf onderwerpen maken om specifieke gebruikersverzoeken en -taken af te handelen
1. Een functioneel onderwerp bouwen dat verbinding maakt met SharePoint-gegevens via connectors en tools

## 🤔 Wat is een onderwerp?

Een onderwerp is een gestructureerd gesprek dat je agent helpt om te reageren op specifieke vragen of taken van gebruikers. Zie een onderwerp als een mini-gesprek of taak die je agent kan afhandelen. Elk onderwerp is ontworpen om te reageren op een specifieke vraag of verzoek van een gebruiker.
...
**Taakuitvoering** - helpt gebruikers iets te _doen_:
...
Je kunt ook onderwerpen maken voor vage vragen zoals `Ik heb hulp nodig`, waarbij gebruikers om meer details wordt gevraagd voordat het gesprek verder gaat.

## 🐦 Waarom zijn onderwerpen nuttig?

Onderwerpen helpen je om:

- De kennis van je agent te organiseren.

- Gesprekken natuurlijker te laten aanvoelen.

- Problemen van gebruikers effectief op te lossen.
...
1. **Aangepaste onderwerpen** - deze maak je zelf om specifieke taken of vragen af te handelen zoals:
...
Voor een onderwerp over het aanvragen van een apparaat kunnen triggerzinnen zijn:
...
Een onderwerp bestaat uit knooppunten, dit zijn stappen die de agent volgt zodra het onderwerp wordt geactiveerd. Je verbindt deze stappen om een gespreksflow te bouwen die je agent volgt bij interactie met gebruikers.

Zie deze als instructies of acties zoals:
...
- Voorwaarden gebruiken om het gesprek te vertakken
...
Met dit knooppunt kan je agent berichten naar gebruikers sturen, die eenvoudige tekst of rijke inhoud zoals afbeeldingen, video's, kaarten, snelle antwoorden en adaptieve kaarten kunnen bevatten.
...
Dit knooppunt wordt gebruikt om gebruikers specifieke informatie te vragen tijdens een gesprek en hun antwoorden op te slaan in variabelen voor later gebruik.

Je kunt het type vraag aanpassen, zoals tekstinvoer, of entiteiten gebruiken voor een gedefinieerde lijst van waarden waaruit een gebruiker kan kiezen. Je kunt ook instellen hoe de agent moet reageren als de gebruiker een ongeldig antwoord geeft of de vraag overslaat.

Het ondersteunt ook rijke inhoud zoals afbeeldingen en snelle antwoorden, en je kunt validatie, herhaling en onderbrekingsinstellingen verfijnen om de gespreksflow soepel te laten verlopen.

!!! tip
    Zie het als een "vraag en luister"-blok dat je agent helpt om gestructureerd met gebruikers te communiceren op een manier die jij definieert.

#### Vraag met adaptieve kaart

- **Doel** - stuurt een rijke, interactieve kaart met behulp van JSON.
- **Voorbeeld** - een kaart die een kalenderdatumkiezer toont voor een gebruiker om een datum te selecteren.
...
- **Doel** - voegt logica toe aan het gesprek. Het controleert iets en beslist wat de volgende stap is.
...
Dit knooppunt stelt je agent in staat om van het ene onderwerp naar het andere te springen zonder het gesprek opnieuw te starten, het onderwerp te beëindigen, het gesprek over te dragen of te beëindigen, of naar een andere stap binnen hetzelfde onderwerp te gaan. Het helpt gebruikers door verschillende delen van de gespreksflow te leiden door soepel tussen onderwerpen te schakelen, en je kunt variabelen tussen hen doorgeven om de context te behouden.

!!! tip
    Zie het als een "ga naar een andere sectie/stap"-blok dat je agent flexibel maakt in het chatten met gebruikers.
...
#### Knooppunt voor generatieve antwoorden

- **Doel** - gebruikt een groot taalmodel om natuurlijke, mensachtige antwoorden te genereren op basis van de vraag van de gebruiker en eventuele verbonden gegevens.
- **Voorbeeld** - gebruikt de verbonden kennisbron die informatie bevat over vakantieverlofrechten om vragen van gebruikers over vakantieaanvragen te beantwoorden.

Dit knooppunt stelt je agent in staat om te reageren op vragen van gebruikers met informatie uit verschillende kennisbronnen, zoals websites, documenten, SharePoint of aangepaste gegevens. Het kan worden gebruikt als een back-up wanneer er geen overeenkomend onderwerp wordt gevonden, of binnen een onderwerp om meer gedetailleerde, dynamische antwoorden te geven op basis van specifieke bronnen die je hebt geconfigureerd voor je agent.

!!! tip
    Zie het als een "slim antwoordblok" dat je agent helpt om nuttige, nauwkeurige antwoorden te geven door te zoeken in betrouwbare inhoud die jij definieert.
...
- **Voorbeeld** - wanneer een gebruiker vraagt naar zijn vakantiedagen, voert de agent een `GET`-verzoek uit naar het verlofbeheersysteem, haalt de `remainingLeaveDays` uit de API-reactie en antwoordt de gebruiker met de waarde.

Dit knooppunt stelt je agent in staat om verbinding te maken met externe systemen door REST API-aanroepen te verzenden, zoals `GET`- of `POST`-verzoeken. Je kunt het verzoek aanpassen met headers, inhoud van de body en zelfs Power Fx gebruiken om dynamische gegevens op te nemen, en vervolgens de reactie opslaan in variabelen voor later gebruik in het gesprek.
...
Dit knooppunt laat je agent niet-berichtacties verzenden naar externe systemen of kanalen, die vervolgens kunnen beslissen hoe ze moeten reageren. Je geeft elke gebeurtenis een naam en voegt een waarde toe, die een eenvoudig nummer of tekst, een variabele of een Power Fx-formule kan zijn, en het wordt verzonden als een JSON-object.

!!! tip
    Zie het als een "stille trigger"-blok dat je agent helpt om dingen achter de schermen te doen of te communiceren met externe tools zonder dat een gebruiker iets hoeft te zeggen.

## 🏋🏻‍♀️ Power Fx gebruiken in je knooppunten

In Copilot Studio is Power Fx een low-code programmeertaal die wordt gebruikt om logica en dynamisch gedrag toe te voegen aan je agent. Het is dezelfde taal die wordt gebruikt in Microsoft Power Apps en is ontworpen om eenvoudig en Excel-achtig te zijn, waardoor het gemakkelijk is voor ontwikkelaars en niet-ontwikkelaars.
...
- Voorwaarden creëren
      - Voorbeeld: `If(score > 80, "Pass", "Fail")`
...
- **Krachtig:** het stelt je in staat om gesprekken te personaliseren, invoer te valideren en te bepalen hoe je agent zich gedraagt op basis van gebruikersgegevens.

## 🏗️ Hoe maak en bewerk ik onderwerpen?

Er zijn twee manieren waarop je onderwerpen kunt maken en bewerken voor je agenten.

### 1. Maak vanaf nul

Hiermee kun je aangepaste gespreksflows helemaal opnieuw bouwen, en je kunt knooppunten naar wens toevoegen of verwijderen bij het bewerken van je onderwerp.
...
- Ondersteunt geen geavanceerde instellingen zoals hoe de gebruiker opnieuw te vragen als ze niet reageren of hoe onderbrekingen tijdens een vraag te beheren. Je kunt deze instellingen indien nodig nog handmatig aanpassen.
...
- Maakt het eenvoudiger om gesprekstromen te verbeteren en itereren met minimale inspanning.
...
### 🔀 Stap 4 - Omgaan met verschillende gesprekstypen
...
Dit onderwerp bevat een generatieve antwoordknoop, waarmee je agent direct gebruik kan maken van verbonden kennisbronnen. Alle kennisbronnen die op agentniveau zijn toegevoegd, worden automatisch opgenomen in de generatieve antwoordknoop binnen het _Conversational boosting_ systeemonderwerp.
...
- AI kan nauwkeurige antwoorden halen uit betrouwbare kennisbronnen.
...
Adaptive Card heeft een startdatum- en einddatumkalenderpicker.

#### Stap 3: Gebruiker geeft data op

Gebruiker selecteert startdatum als 5 augustus 2025 en einddatum als 10 augustus 2025, en verzendt de kaart. Datumwaarden worden opgeslagen in de uitvoer van de Adaptive Card als variabelen.

#### Stap 4: Cloudflow uitgevoerd

Een Power Automate-cloudflow is uitgevoerd die een nieuw verzoek aanmaakt in het verlofbeheersysteem en een e-mail stuurt om de manager op de hoogte te stellen van het verlofverzoek.

#### Stap 5: Stuur een bevestigingsbericht naar de gebruiker

Agent reageert met,

`Je vakantieverlofaanvraag van 5 augustus tot 10 augustus is ingediend. Je manager zal het beoordelen en binnenkort contact met je opnemen.`

## 🧪 Lab 07 - Voeg een nieuw onderwerp toe met gespreksknooppunten

We gaan nu leren hoe je een nieuw onderwerp toevoegt met een trigger en tools. In deze lab behandelen we het maken van een onderwerp vanaf nul, zodat je begrijpt hoe je onderwerpen aanpast aan je behoeften.
...
1. Vervolgens gaan we een nieuwe invoervariabele toevoegen die generatieve AI zal gebruiken in zijn orkestratie om de waarde van het apparaattype uit het bericht van een gebruiker te halen. Selecteer de **Meer ellipsis (...)** in het onderwerp en selecteer **Details** om het detailvenster van het onderwerp te bekijken.
...
1. Selecteer **Maak een nieuwe variabele**.
    ...
    ![Maak nieuwe invoervariabele](../../../../../translated_images/7.2_03_CreateANewVariable.0d45780268d9b6250617c45a9ddd557cdaa23945b66539b313ca8d74f2c96cc2.nl.png)
...
1. We moeten nu onze invoer- en uitvoervariabelen definiëren. De volgende eigenschappen kunnen worden gedefinieerd voor onderwerpinputs en -outputs.
    ...
    | Identificeer als  | Entiteitstype voor de agent om het juiste waardetype vast te leggen  |
    ...
    De _Hoe vult de agent deze invoer?_, _Variabele datatype_ en _Weergavenaam_ kunnen blijven zoals ze zijn. Werk de **Identificeer als**-eigenschap bij naar **Volledige reactie van gebruiker**.
...
1. Laten we nu onze uitvoer voor het onderwerp definiëren. Selecteer het **Uitvoer**-tabblad.
...
1. Selecteer **Maak een nieuwe variabele**.
    ...
    ![Maak nieuwe uitvoervariabele](../../../../../translated_images/7.2_08_CreateANewVariable.5518205f121014ff4757af062bedfd38ce768c8f38291dd9d6489d67cd5d5dc8.nl.png)
...
1. We hebben nu het definiëren van de inputs en outputs van het onderwerp voltooid. Selecteer het **X-icoon** om te sluiten vanuit het **Detailvenster van het onderwerp**.

    ![Sluit vanuit detailvenster van onderwerp.](../../../../../translated_images/7.2_10_ExitTopicDetailsPane.6e8981434f04049bef7ab93f9545ee433087e1c99cdfe27b355ee9858ddfde99.nl.png)
...
1. Selecteer het **Voeg een tool toe**-knooppunt, selecteer vervolgens het **Connector**-tabblad. Zoek naar `Get items` en selecteer de **Get items** SharePoint-connectoractie.
...
1. Er worden twee opties weergegeven waarmee je direct verbinding kunt maken met SharePoint Online of met een on-premises SharePoint. Standaard is de **Direct verbinden (cloud-services)**-optie geselecteerd, wat we zullen gebruiken voor onze verbinding.
Selecteer **Maken**.

![Select Create](../../../../../translated_images/7.3_04_SelectCreate.f2216f1e276ed153e06d5b5d47f170a0f9cc6854aa05f0736623acb3aeee1229.nl.png)

1. Selecteer je ingelogde gebruikersaccount.

![Select signed in user account](../../../../../translated_images/7.3_05_SelectSignedInUserAccount.e27a0ada918a1cf4477f3966adcc5f1d033a8998a2589d02d1208f21f5d93938.nl.png)
...
![Select allow access](../../../../../translated_images/7.3_06_AllowAccess.69f012dbcedf7ebc1869e648a5eaa661d085b15aa7a2eb69e69c5b63adfa36dd.nl.png)
...
![Submit](../../../../../translated_images/7.3_07_ConnectedSelectSubmit.16ec31ef062696cabb6e7964879debd177f2b9162f88ef95ae1b4eed85e08a21.nl.png)

1. De **Get items**-actie van de SharePoint-connector is nu toegevoegd aan het onderwerp. We kunnen nu beginnen met het configureren van de invoer van de actie. Selecteer het **ellips (...)-pictogram** en selecteer **Eigenschappen**.

![Select Properties](../../../../../translated_images/7.3_08_GetItemsProperties.32bdda34a1d73a55eb2893695e4b4cf15cd899806e616d0b0b5015471414c9d7.nl.png)
...
> Dit zal handig zijn wanneer we de pagina _Beheer je verbindingen_ van onze agent bekijken. Hier komen we zo op terug.

![Get items description](../../../../../translated_images/7.3_09_UpdateDescription.76a8d2ebddd4c3e4ca423daad7485afa60f31f37c97e16529d94e224f9709d60.nl.png)
...
![Configure Get items inputs](../../../../../translated_images/7.3_10_GetItemsInputs.17f8689e660c480dd405ab2ab57db34dcd2b8e697ec09d54c8f8649eb619c58b.nl.png)

1. Om alleen apparaten uit de SharePoint-lijst weer te geven op basis van:
   - de geselecteerde waarde,
   - en alleen apparaten waarvan de status _Beschikbaar_ is,

moeten we een filter toepassen. Dit wordt gedaan door een filterquery in te voeren met behulp van Power Fx. Selecteer het **ellips (...)-pictogram**.

![Select ellipsis icon](../../../../../translated_images/7.3_11_SelectVariable.33bfe876cc230569ea0f6cc5e1efa100432509e44342e9b3d6a9e65ee2bc525f.nl.png)

1. Standaard bevind je je op het tabblad **Aangepast**. Selecteer het tabblad **Formule**.

![Select Formula tab](../../../../../translated_images/7.3_12_SelectFormula.a7aba25c95956d113865da3f30da3f3872e12c7a7a8f3c65098a3e3fac9616a4.nl.png)

1. Selecteer het **uitvouwpictogram** om het veld **Formule** te vergroten. Kopieer en plak de volgende Power Fx-uitdrukking.

We gebruiken de functie `Concatenate` om een uitdrukking te maken die filtert:
- de SharePoint-kolom **Status** gelijk aan _Beschikbaar_
- en de SharePoint-kolom **Apparaattype** gelijk aan _het geselecteerde apparaat van het vraagknooppunt_.
...
![Enter Power Fx expression and select insert](../../../../../translated_images/7.3_13_EnterFormula.d17cc9f73e01e1cab8e2420a55bcb726ae0a0e55673f81ee3d7fe12d20148b92.nl.png)

1. De Power Fx-uitdrukking wordt nu toegepast in de Filter Query-invoervariabele van de **Get items**-actie. Selecteer vervolgens de **Alle items**-weergave in **Kolommen beperken op weergave**. Dit haalt alleen de kolommen in de lijst op op basis van de geselecteerde weergave.

![List Columns by View](../../../../../translated_images/7.3_14_LimitColumnsByView.5537126aaa087bd7f81cc35dfe182aa72cdbec4fe1fb5c2e15823a1275dcaa71.nl.png)

1. Vervolgens gaan we de naam van de variabele voor de uitvoer bijwerken. Selecteer het tabblad **Outputs** en selecteer de variabele `GetItems`.

![Update variable](../../../../../translated_images/7.3_15_ConfigureOutputs.d4cb0c5c8e37d1859ed705bd1582fce2d063e7f4d65cc036127a846d743ff391.nl.png)
...
![Update variable name](../../../../../translated_images/7.3_16_RenameVariable.55d7adb355808d39fe515bf980af123c60e218fa427354079e86efc412dc0f83.nl.png)
...
![Update to Global variable](../../../../../translated_images/7.3_17_UpdateToGlobalVariable.09bdb05c0938898a04e48b6bcebee1584f17080b63b2577594be74f9f77a5bc3.nl.png)

1. **Sluit** het paneel **Variabele eigenschappen**.

![Close Variable properties pane](../../../../../translated_images/7.3_18_ExitVariablePropertiesPane.b1a5e76dfe490bdf1274d8e8c78df44f9b3e3542180fa52fb6f903a980ef31ab.nl.png)
...
![Add Set a variable value node](../../../../../translated_images/7.3_19_AddSetAVariableValueNode.958d21c21727ef92506fe76cf0458f05ac8508d84d0a4917077d2889410330e2.nl.png)

1. Selecteer het **groter dan**-pictogram voor de invoervariabele **Set variable**.

![Set variable](../../../../../translated_images/7.3_20_SelectAVariable.9d3beb144002569b947c90cbec22afcc9cb34f277b21e3f65dcaf69831abc438.nl.png)

1. Selecteer de eerder gemaakte onderwerpuitvoer als de variabele, **VarAvailableDevices**.

![Save topic](../../../../../translated_images/7.3_21_SelectVarAvailableDevicesOutput.8d7259eb6ce1bc7c89de10b768b62dc3008ad7468c094249282bfe66436d1672.nl.png)

1. Selecteer vervolgens het **ellips (...)-pictogram** om de waarde van de variabele te definiëren.

![Select variable value](../../../../../translated_images/7.3_22_SelectVariable.f16319e644afc97d24a8cddaf64a7df9fcc52acd7e284b21f20b685a6e53887a.nl.png)

1. We gaan nu een PowerFx-uitdrukking gebruiken om de variabelewaarde in te stellen als de `value`-eigenschap die wordt geretourneerd in de **Get items**-reactie, en de [scope van de variabele](https://learn.microsoft.com/microsoft-copilot-studio/advanced-power-fx?WT.mc_id=power-172618-ebenitez) globaal maken door het voorvoegsel `Global` toe te voegen.

Selecteer **Invoegen** en **sla** het onderwerp op.

![Power Fx formula for variable value](../../../../../translated_images/7.3_23_PowerFxFormula.f860daa2c8423021926f0697177279ede3d8d443714d471a77e655c3c42edb07.nl.png)

1. Vervolgens moeten we de instructies van de agent bijwerken. Selecteer het tabblad **Overzicht** en selecteer **Bewerken**.

![Edit instructions](../../../../../translated_images/7.3_24_EditInstructions.ce65a6cbcd74792885230af1da432fbb4079fd8b0f5af24ab840453a900b67a8.nl.png)
...
Deze instructie zal generatieve AI begeleiden om de **Beschikbare apparaten**-trigger aan te roepen om de lijst met beschikbare apparaten uit de **Devices** SharePoint-lijst weer te geven. Selecteer de gehele onderwerpplaceholder tussen vierkante haakjes.

![Add instructions](../../../../../translated_images/7.3_25_AddInstructions.1e83853476fed3c8b1c43e657bd1c1351108702288a8f688d8543fbf1c2946fb.nl.png)

1. Typ het schuine streep-teken `/` en de lijst met onderwerpen verschijnt. Selecteer het onderwerp **Beschikbare apparaten**.

![Reference trigger](../../../../../translated_images/7.3_26_SelectAvailableDevicesTopic.1a1beaa256f5417153b7bc55de848b89778f666c213b3a3935444526ab881f0b.nl.png)

1. **Sla** de bijgewerkte instructies op.

![Save instructions](../../../../../translated_images/7.3_27_SaveUpdatedInstructions.39908bb60990be971039bf392088fd0ecfa148c4496a6ad7413e1267b9091623.nl.png)

1. We gaan nu onze bijgewerkte agent testen. Selecteer **Testen** rechtsboven om het testpaneel weer te geven en **ververs** het testpaneel. Voer het volgende bericht in bij de agent.
...
![Select allow](../../../../../translated_images/7.3_29_SelectAllow.9f508c4001270252924d889792ecf0cc2a984954b903bb00f7ce6b2dc43d08e3.nl.png)

1. De agent zal de SharePoint-tool uitvoeren die een gefilterde lijst met apparaten ophaalt waarbij het apparaattype gelijk is aan "laptop" en de status gelijk is aan "beschikbaar," op basis van de gebruikte Power Fx-uitdrukking. Een reactie in de vorm van opsommingstekens wordt geretourneerd voor de gebruiker om te lezen.

![Response of test](../../../../../translated_images/7.3_30_TestResponse.b60253568edc8b68d737a62960f4a3fa3620d2ba4658b05aa2503ad5fd763383.nl.png)

1. Het laatste wat we leren is het bekijken van de gebruikte verbindingen door de pagina _Beheer je verbindingen_ van de agent te bekijken. Selecteer het **ellips (...)** en selecteer **Beheer verbinding**.

![Manage connection](../../../../../translated_images/7.3_31_ManageConnections.151932ec4f907e020b67c418cf591806da164c74f6b1d9b73c04d7374d9fc505.nl.png)
...
![Used By](../../../../../translated_images/7.3_32_UsedBy.1e5ff032f1e02a565a0dafdde4f9436486ed3f012fcc23b824871a71b6de543e.nl.png)
...
> Dit laat ons weten welke acties worden gebruikt en het doel ervan. Dit houdt onze verbindingen georganiseerd 📁.

![Usage description](../../../../../translated_images/7.3_33_UsedByInformation.74a42aedb6dc906c678ff8b281a8706e1c0156ee7375111ed20e02d1a1dfd808.nl.png)

1. Ga terug naar je browsertabblad met Copilot Studio en **ververs** het testpaneel om de test te wissen.

## ✅ Missie Voltooid

Gefeliciteerd! 👏🏻 Je hebt geleerd hoe je een nieuw onderwerp vanaf nul toevoegt, hoe je een tool toevoegt die de Get items SharePoint-connectoractie aanroept en Power Fx gebruikt om de reactie te filteren zodat alleen apparaten worden geretourneerd waarvan de status beschikbaar is en het apparaattype laptop is. 🙌🏻

Dit is het einde van **Lab 07 - Een nieuw onderwerp toevoegen met gespreksknooppunten**, selecteer de onderstaande link om naar de volgende les te gaan. We zullen de use case in dit lab uitbreiden in de lab van de volgende les.
