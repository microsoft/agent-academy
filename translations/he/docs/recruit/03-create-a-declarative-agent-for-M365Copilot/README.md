...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-17T05:54:14+00:00",
...
1. להשוות בין Microsoft Copilot Studio לבין בונה סוכנים של Copilot Studio לבניית סוכנים דקלרטיביים
1. ליצור סוכן דקלרטיבי באמצעות שפה טבעית דרך חוויית יצירה שיחתית
1. להוסיף הנחיות AI ככלים לשיפור הידע המיוחד של הסוכן ויכולות פתרון הבעיות שלו
...
כמייצרים, ייתכן שכבר חקרתם את [בונה סוכנים של Copilot Studio](https://learn.microsoft.com/microsoft-365-copilot/extensibility/copilot-studio-agent-builder?WT.mc_id=power-172614-ebenitez) ב-Microsoft 365 Copilot ולכן אתם כנראה תוהים _למה לבנות סוכן דקלרטיבי ב-Microsoft Copilot Studio?_

Microsoft Copilot Studio מציע סט כלים ותכונות מקיף עבור סוכנים דקלרטיביים שמרחיק מעבר למגבלות של בונה סוכנים של Copilot Studio. בדומה לבונה סוכנים של Copilot Studio, אין צורך לדעת תכנות או פיתוח תוכנה כדי לבנות ב-Microsoft Copilot Studio. בואו נפרט יותר כדי להבין את ההבדלים בין בונה סוכנים של Copilot Studio לבין Copilot Studio לבניית סוכנים דקלרטיביים.

### השוואת תכונות

הטבלה הבאה מדגישה את ההבדלים בבניית סוכן דקלרטיבי בבונה סוכנים של Copilot Studio וב-Copilot Studio.

| תכונה                   | בונה סוכנים של Copilot Studio ב-Microsoft 365 Copilot                          | הרחבת Microsoft 365 Copilot ב-Copilot Studio                                |
|---------------------------|-------------------------------------------------------|------------------------------------------------------------|
...
| **כלים**       | מפרש קוד, יוצר תמונות     | 1400+ מחברי Power Platform, מחברים מותאמים אישית, הנחיות, שימוש במחשב, REST API, Model Context Protocol   |
...
!!! tip
    - כדי ללמוד עוד על בונה סוכנים של Copilot Studio, בקרו ב-[מחנה מפתחים של Copilot: מעבדה MAB1 - בניית הסוכן הראשון שלכם](https://microsoft.github.io/copilot-camp/pages/make/agent-builder/01-first-agent/)
    - לפיתוח מתקדם של הרחבת סוכן דקלרטיבי מעבר לבונה סוכנים של Copilot Studio עבור Microsoft 365 Copilot, בקרו ב-[מחנה מפתחים של Copilot: מעבדה MAB1 - בניית הסוכן הראשון שלכם](https://microsoft.github.io/copilot-camp/pages/extend-m365-copilot/)
...
- **גישה לידע ארגוני**: מאפשר גישה לידע ארגוני תוך שמירה על הרשאות המשתמש.
...
- **אינטגרציה עם שירותים חיצוניים**: מאפשר לבחור מתוך 1400+ מחברי Power Platform שמתחברים לשירותים חיצוניים, ומספקים פונקציונליות מורכבת וחזקה יותר.
...
- **הנחיות AI**: השתמשו בהנחיה לניתוח והמרת טקסט, מסמכים, תמונות ונתונים עם שפה טבעית והסקת AI.
  - בחרו את מודל הצ'אט, בחרו מתוך Basic (ברירת מחדל), Standard, Premium
  - אפשרות להביא מודל Azure AI Foundry משלכם כדי להנחות את ההנחיה
...
- **אפשרויות תצורת פריסה נוספות**: בחרו ערוצים והגדירו הרשאות משתמשים.
  ...
  - הרשאות עריכה למשתמשים יכולות להיות משותפות כדי למנוע תלות בנקודה יחידה בבעל הסוכן
...
לסיכום, סוכנים דקלרטיביים ב-Microsoft Copilot Studio מאפשרים התאמה אישית של Microsoft 365 Copilot לצרכים עסקיים באמצעות אינטגרציה של מערכות ידע ארגוניות, כלים לחיבור לשירותים חיצוניים או מודלים של GPT AI.

## 🧪 מעבדה 03: בניית סוכן דקלרטיבי ב-Microsoft Copilot Studio עבור Microsoft 365 Copilot

נלמד כעת כיצד לבנות סוכן דקלרטיבי עבור מקרה שימוש "עסק לעובד" שישמש כסוכן **שירות תמיכה טכנית IT**.
...
**אני רוצה** לקבל עזרה מהירה ומדויקת מסוכן שירות תמיכה טכנית IT עבור בעיות כמו בעיות במכשירים, פתרון בעיות ברשת, הגדרת מדפסת
...
- על המייצרים להיות בעלי הרשאות ליצור ולהיות בעלי גישה לסביבת Copilot Studio.
...
1. נווטו ל-[https://copilotstudio.microsoft.com/](https://copilotstudio.microsoft.com/) והתחברו באמצעות האישורים שלכם. ודאו שאתם עוברים לסביבה שבה אתם משתמשים עבור מעבדות אלו.
...
1. לאחר מכן, ניצור סוכן דקלרטיבי על ידי בחירת **+ הוסף** סוכן.

       ![הוסף סוכן](../../../../../translated_images/3.1_03_AddAgent.1971234c27e9cd9f17c73e6214045224638279df05417f7af6a5f446158d39de.he.png)

1. נראה את חוויית יצירת השיחה נטענת, שבה נוכל לשוחח בשפה טבעית עם קופיילוט כדי לתאר את הסוכן הדקלרטיבי שאנחנו רוצים לבנות, ולהשתמש בשאלות המוצעות להכוונה.
       ...
       ```text
       אתה איש מקצוע IT מיומן ומנוסה המתמחה במגוון רחב של מערכות מחשבים, רשתות ואבטחת סייבר. אתה מסוגל לאבחן ולפתור בעיות טכניות, להסביר פתרונות בצורה ברורה ומובנת למשתמשים בכל רמות הטכניות, ולספק הדרכה על שיטות עבודה מומלצות. עליך להיות תמציתי ואינפורמטיבי, להשתמש בהוראות שלב אחר שלב עם נקודות תבליט כאשר זה מתאים. מטרתך היא לעזור למשתמש להבין את הבעיה וכיצד לפתור אותה בצורה יעילה.
       ```
...
1. לאחר שליחת ההנחיה, תופיע עדכון בולט בצד ימין של הפאנל עם הפרטים וההוראות של הסוכן כפי שהוגדרו בהנחיה. לאחר מכן תתבקשו לאשר את שם הסוכן וקופיילוט יציע שם.
       ...
       ![הוראות עודכנו](../../../../../translated_images/3.1_05_InstructionsUpdated.110cd93fa69ba2627e59aef2c555eebe7f91a85880b094cde9205b2069991a9d.he.png)

    !!! warning "תזכורת: שאלות קופיילוט עשויות להשתנות בין מפגשים"

        חוויית יצירת השיחה של קופיילוט עשויה להשתנות בכל פעם, כאשר השאלות המוצעות להכוונה עשויות להיות מעט שונות מהפעם הקודמת.

1. שם הסוכן עודכן כעת כפי שנראה בצד ימין של הפאנל. כעת נתבקש לחדד את ההוראות עבור הסוכן. מה שקופיילוט הציע נשמע נהדר, אז נבקש ממנו להשתמש בהצעות שלו. נכניס את הדברים הבאים,

      ```text
      Focus on the IT issues and scenarios you've identified
      ```

      ![שם עודכן](../../../../../translated_images/3.1_06_NameUpdated.b6b8cc7c670b77c635d6b54b723e1a83f63ec288c0eab260fdbf88c7ec163003.he.png)

1. לאחר מכן נשאל אם אנחנו רוצים להוסיף אתרים ציבוריים או ידע. נענה ב-`לא` מכיוון שנוסיף רק הנחיה לסוכן הדקלרטיבי שלנו במעבדה זו. מעבדות עתידיות בשיעורים הבאים יכסו מקורות ידע.
...
1. לאחר מכן נראה תגובה מקופיילוט שסיימנו כעת להגדיר את הסוכן שלנו באמצעות חוויית יצירת השיחה של קופיילוט. עם זאת, בואו נחדד אותו עוד יותר על ידי פירוט שהוא צריך להיות תמציתי ואינפורמטיבי עם נקודות תבליט, להשתמש באמפתיה בתקשורת ולבקש משוב לאחר מתן פתרונות.
...
1. קופיילוט מאשר שההוראות עודכנו. לחצו על **צור** כדי להקצות את הסוכן הדקלרטיבי עבור Microsoft 365 Copilot.
...
![פרטי סוכן](../../../../../translated_images/3.1_10_01_AgentDetails.fb8fe8548ca78833acf1048565e0e00b8eeb4132bc7c425d4532048df090b67b.he.png)

גלול מטה בלוח ותראה גם את היכולות להוסיף ידע, להפעיל חיפוש באינטרנט (באמצעות Bing), הנחיות התחלתיות ופרטי הפרסום של הסוכן ההצהרתי עבור Microsoft 365 Copilot. ההנחיות ההתחלתיות יוצגו גם בלוח הבדיקה בצד ימין. משתמשים יכולים לבחור בהנחיות ההתחלתיות כדי להתחיל אינטראקציה עם הסוכן.
...
1. בחלק הפרטים של הסוכן, יש לך את היכולת לשנות גם את סמל הסוכן. בחר **ערוך**.
...
1. בוא נעשה בדיקה מהירה של הסוכן שיצרנו. בחר אחת מההנחיות ההתחלתיות בלוח הבדיקה בצד ימין.

![בדוק הנחיה התחלתית](../../../../../translated_images/3.1_12_TestUsingStarterPrompt.4646f93c027503eaa719d98a1634206abf6f48ad11279e231e43b14f89a3034e.he.png)

1. הסוכן שלנו יגיב. שים לב כיצד הוא פועל לפי ההוראות על ידי מתן נקודות עיקריות בצורה מובנת, ומשתמש באמפתיה בתגובתו.

אם תגלול לתחתית ההודעה, שים לב כיצד הוא גם מבקש משוב לאחר מתן פתרון כפי שהונחה.
...
1. חלון הכלים יופיע ורשימה של מחברים של Power Platform תוצג. כדי להוסיף הנחיה, בחר **+ כלי חדש**.
...
1. בחר **סמל החץ** ליד **מודל** כדי לראות את המודלים השונים של צ'אט שתוכל לבחור מהם. כברירת מחדל, מודל **Basic GPT-4.1 mini** נבחר ויש לך גם את האפשרות להשתמש במודל משלך באמצעות Azure AI Foundry Models. נישאר עם המודל שנבחר כברירת מחדל.
...
- להשתמש ב-Copilot כדי ליצור הוראות עבורך בהתבסס על תיאור של מה שאתה רוצה שההנחיה תעשה.
- להשתמש בתבנית מוכנה מהספרייה של ההנחיות כדי ליצור הנחיה.
- להזין ידנית את ההוראות שלך.

1. נתחיל בלנסות להשתמש ב-Copilot כדי ליצור הוראות בהתבסס על תיאור שהוזן. הזן את הטקסט הבא בשדה של Copilot ושלח.
...
![טיוטת הוראות שנוצרה על ידי Copilot](../../../../../translated_images/3.2_08_CopilotGeneratedInstructions.49fd579bc80276690ac5d912f451d525669fe07d7f37d85580888a441ecdbc0e.he.png)

1. גלול לתחתית ההוראות ותראה את פרמטר הקלט של המשתמש שכבר הוגדר על ידי Copilot. יש לך את האפשרות:
- לשמור את טיוטת ההוראות שנוצרה.
- לרענן את טיוטת ההוראות באמצעות Copilot.
- לנקות את טיוטת ההוראות.

נקה את טיוטת ההוראות על ידי בחירת סמל **פח האשפה** וננסה את הספרייה של ההנחיות.
...
1. כעת, נוכל להגדיר את פרמטרי הקלט של המשתמש עבור ההנחיה שלנו. אלו יכולים להיות טקסט ותמונות, ונתוני דוגמה לבדיקה. יש גם את היכולת לקשר את ההנחיה עם ידע מטבלאות Dataverse. בתרגיל זה, יש לנו רק קלט משתמש אחד להגדיר שהוא קלט הבעיה. זה כרגע מציין מקום בהנחיה שלנו כ-[Problem]. כעת נגדיר את הקלט הזה על ידי הזנת התו `/` או בחירת **+הוסף תוכן** ואז לבחור **טקסט**.
...
1. פרמטר קלט הבעיה יתווסף כעת להוראות עם נתוני הדוגמה שהוגדרו. כעת נוכל לבדוק את ההנחיה שלנו!
...
1. התגובה תוצג. שים לב כיצד התגובה מספקת כותרות עם נקודות עיקריות בהתאם להוראות. גלול מטה ובדוק את שאר התגובה של המודל.
...
1. לפני שנשמור את ההנחיה שלנו, נלמד על ההגדרות שניתן להגדיר עבור ההנחיה הזו. בחר את סמל **שלוש הנקודות (...)**.
...
- **כלול קישורים בתגובה**: כאשר נבחר, התגובה כוללת ציטוטי קישורים עבור הרשומות שנשלפו.
...
1. כעת אנחנו מוכנים לבדוק את ההוראות המעודכנות של הסוכן ההצהרתי שלנו. בחר את סמל **רענן** בלוח הבדיקה.

![בחר סמל רענן](../../../../../translated_images/3.3_03_RefreshTestPane.dc6058feab088db4abf25b950466a2e6f5a23b97d3d9eacb65c913a012e7779b.he.png)

1. לאחר מכן, הזן את ההנחיה הבאה ושלח.
...
1. חלון יופיע שמציג את הערוצים ופרטי הפרסום שניתן לעדכן.
...
!!! tip
אם אינך רואה את כל השדות המוצגים בדפדפן שלך, נסה להקטין את הזום לדוגמה ל-75%.
...
| אפשרות זמינות | תיאור |
| ---------- | ---------- |
| קישור שיתוף | העתק את הקישור כדי להפיץ אותו עם משתמשים משותפים לפתוח את הסוכן ב-Microsoft 365 Copilot |
| הצג לחברי הצוות שלי ולמשתמשים משותפים | מאפשר לך להעניק גישה לאחרים להשתתף ביצירת הסוכן, או לקבוצות אבטחה להעניק להם גישה להשתמש בסוכן ב-Microsoft 365 Chat או ב-Microsoft Teams. |
...
- _זמין נבנה עם Power Platform_ - הסוכן הופך לזמין בסעיף נבנה עם Power Platform בחנות האפליקציות של Teams.
...
בחרו **Cancel** או סמל **X** כדי לצאת מהחלון.

![שיתוף סוכן](../../../../../translated_images/3.4_05_ShareAgent.991664ebeb3f292f7afaaf9dc45f6f09c5adff34b3f178fbe2f569a5a4d75855.he.png)

1. בחרו **Copy** ובטאב חדש בדפדפן, הדביקו את הקישור.

![העתקת קישור](../../../../../translated_images/3.4_06_CopyLink.1e048be824c352cf1af678a1f6425e21aff9d1768fcb2f2e6dfb243cba1dc776.he.png)

1. Microsoft 365 Copilot ייטען וחלון מודאלי יופיע עם פרטי אפליקציית הסוכן. שימו לב לשם המפתח, התיאור הקצר והתיאור הארוך שמוצגים. אלו נלקחו מפרטי הפרסום שעודכנו בשלב קודם.
...
1. הסוכן ההצהרתי שלנו ייטען. נוכל לראות את ההנחיות ההתחלתיות לבחירה, שמאפשרות למשתמשים לקבל עזרה מיידית.

בחרו אחת מההנחיות ההתחלתיות. בהנחיות שלי, אבחר בהנחיה **עזרה בהתקנת תוכנה**, שתמלא אוטומטית את שדה ההודעה של Copilot. שלחו את השאלה ל-Copilot.
...
1. בחרו **Always allow** כדי לתת לסוכן ההצהרתי שלכם הרשאה להפעיל את הנחיית מומחה ה-IT.

![בחירת תמיד לאפשר](../../../../../translated_images/3.4_09_AlwaysAllow.b6561f2d7b0b91bb8ad534df057ada512c9d877a0388dbdbe36916f55955b5cd.he.png)

1. הסוכן יפעיל את הנחיית **מומחה ה-IT** ונראה את תגובת המודל שמוחזרת כהודעה בסוכן ההצהרתי שלנו.
...
הכניסו את הטקסט הבא בשדה ההודעה של Copilot ושלחו.

    ```text
    -developer on
    ```

תופיע הודעת אישור שתיידע אתכם שמצב מפתח הופעל.
...
1. נראה תגובת מודל מהנחיית **מומחה ה-IT** שלנו שוב, שמוחזרת כהודעה. גללו מטה לתחתית ההודעה ותוצג כרטיסייה עם מידע דיבוג.

הרחיבו את **Agent Debug Info** על ידי בחירה בה.
...
1. כאן תמצאו מידע על המטא-נתונים של הסוכן שהתרחשו בזמן הריצה.
...
במקרה שלנו, נתמקד בקטע _Actions_.

- **Matched actions** מדגיש את הסטטוס הנוכחי של הפונקציות שנמצאו במהלך חיפוש האפליקציה.
- **Selected actions** מדגיש את הסטטוס הנוכחי של הפונקציות שנבחרו לפעול בהתבסס על תהליך קבלת ההחלטות של האפליקציה.
...
כאן ניתן לראות שהמתזמן של הסוכן בחר להפעיל את הנחיית מומחה ה-IT בהתאם להוראות הסוכן ההצהרתי שלנו. זה מפורט יותר בקטע _Executed Actions_, שמראה גם שההנחיה הופעלה בהצלחה.
...
1. כדי לכבות את מצב המפתח, הכניסו את הטקסט הבא בשדה ההודעה של Copilot ושלחו.

    ```text
    -developer off
    ```

תופיע הודעת אישור שתיידע אתכם שמצב מפתח כבוי. מעולה, עכשיו אתם יודעים איך לוודא שהסוכן ההצהרתי שלכם ב-Microsoft 365 Copilot הפעיל את ההנחיה שלכם 🌞
...
1. עכשיו נבדוק את הסוכן שלנו ב-Microsoft Teams. נווטו ל-**Apps** באמצעות התפריט בצד שמאל ובחרו **Teams** תחת הקטגוריה _Apps_.

![בחירת Teams ב-Apps](../../../../../translated_images/3.4_16_NavigateToApps.c9747b0f44570fe737aeac7defe5d0125d693aff384e03b864453da70b0c6206.he.png)

1. Microsoft Teams ייטען בטאב חדש בדפדפן ואז יוצגו תנאי השימוש של Microsoft 365 Copilot, בחרו **Agree**.

![בחירת Agree](../../../../../translated_images/3.4_17_Agree.3777ebcf791edd12825395218770987d5b25338b21ab41b7bd7e40b97468ba32.he.png)
...
1. בחרו **סמל שלוש נקודות (...)** בתפריט בצד שמאל. חפשו את **Contoso Tech Support Pro** בשדה החיפוש או אם אתם רואים את הסוכן, בחרו בו.
...
1. תגובת מודל מההנחיה שלנו תוצג.
...
ברכות! 👏🏻 יצרתם סוכן הצהרתי ב-Copilot Studio, הוספתם הנחיה, הנחיתם את הסוכן להשתמש בהנחיה ולמדתם איך לבדוק ולפרסם את הסוכן שלכם ל-Microsoft 365 Copilot ול-Microsoft Teams.

הסוכן שלכם עכשיו מוכן לפעולה—מוכן לעזור, לפתור בעיות ולשרת משתמשים פנימיים לפי דרישה.

זהו סוף **מעבדה 03 - יצירת סוכן הצהרתי ב-Copilot Studio עבור Microsoft 365 Copilot**, בחרו בקישור למטה כדי לעבור לשיעור הבא.

⏭️ [מעבר לשיעור **יצירת פתרון חדש**](../04-creating-a-solution/README.md)

עד הפעם הבאה, הישארו חדים. העתיד של העבודה הארגונית עובר דרך סוכנים—ועכשיו אתם יודעים איך ליצור אחד.
