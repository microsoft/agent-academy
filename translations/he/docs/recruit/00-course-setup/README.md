...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-17T06:05:52+00:00",
...
1. בשלב הבא, תיטען רשימה של תבניות Microsoft כברירת מחדל. גללו מטה ובחרו בתבנית **שולחן עזרה IT**.
...
1. הזינו מידע עבור האתר שלכם. להלן דוגמה:
